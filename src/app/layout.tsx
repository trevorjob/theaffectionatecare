...
export const metadata: Metadata = {
  ...
  description:
    "Professional care services across the United Kingdom. Support, training & development, and supported living for people with autism, learning disabilities, elderly care, and more.",
  keywords: [
    "care company",
    "care support",
    "supported living",
